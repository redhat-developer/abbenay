...
class Engine(_message.Message):
    ...
    default_env_var: str
    display_name: str
    def __init__(self, id: _Optional[str] = ..., requires_key: _Optional[bool] = ..., default_base_url: _Optional[str] = ..., default_env_var: _Optional[str] = ..., display_name: _Optional[str] = ...) -> None: ...
...
class ConsumerCapabilitiesMsg(_message.Message):
    ...
    shutdown: bool
    chat: bool
    def __init__(self, inline_policy: _Optional[bool] = ..., mcp_register: _Optional[bool] = ..., secrets: _Optional[bool] = ..., config: _Optional[bool] = ..., providers: _Optional[bool] = ..., shutdown: _Optional[bool] = ..., chat: _Optional[bool] = ...) -> None: ...
